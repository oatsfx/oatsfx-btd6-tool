...
export const useLocalRoundData = (pos: number) => {
  ...
  const roundSetsDefs: RoundSetDef[] = [
    ...
    { name: "Bloonarius", path: "data/bloonarius.json", isComplete: false },
    { name: "Lych", path: "data/lych.json", isComplete: false },
    { name: "Vortex", path: "data/vortex.json", isComplete: false },
    { name: "Dreadbloon", path: "data/dreadbloon.json", isComplete: true },
    { name: "Phayze", path: "data/phayze.json", isComplete: false },
    {
